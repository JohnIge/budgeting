...
$querye = "INSERT INTO users VALUES (0,'$oname', '$username', '$password', 'User')";
...
echo 'User registration Successful </br></br></br></br></br>';
        ...
        <div class="mainpanel">
            ...
            <div class="contentpanel">
                <div class="panel panel-babcock">
                    <div  class="panel-heading">User Registration
