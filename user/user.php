...
<head>
    ...
    <title>E-mail Phishing Detection System</title>
...
<body>
    ...
    <header>
        <div class="headerwrapper">
            <span class="span-header">E-mail Phishing Detection System</span>
        ...
        <div class="mainwrapper">
            <div class="leftpanel">
                ...
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li class=""><a href="check2.php"><i class="fa fa-wrench"></i> <span>Check email Address for Phishing Detection</span></a>
            ...
            <div class="mainpanel">
                <div class="pageheader">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <h4>E-mail Phishing Detection System Panel</h4>
                        </div>
                    </div><!-- media -->
                </div><!-- pageheader -->
                ...
                <div class="contentpanel">
                    <div class="panel panel-babcock">
                        <div class="panel-heading">Registered Banks and their E-mails
                        ...
                        <div class="panel-body">
                            ...
                            <table class="table table-default mb30 table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    $query = "SELECT * FROM email ORDER BY Sn DESC";
